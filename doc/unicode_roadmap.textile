...
** for UTF-8, *case-folding* is handled by external library (preferably with @towlower@, although Unicode defines a different folding algorithm, e.g. for German _Straße_ vs. _STRASSE_)
