...
* CWB uses the Doxygen system for generating HTML documentation of the functions, structures and global variables in the C source and header files.
**See http://www.doxygen.nl
* Only a _a subset of_ the Doxygen comment syntax is used in CWB:
** Use Javadoc syntax, _not_ any of the other syntaxes supported by Doxygen
