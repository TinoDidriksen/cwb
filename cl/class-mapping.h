...
typedef struct _single_mapping {
  ...
  int64_t nr_tokens;                /**< the number of tokens which this object owns */
  int64_t *tokens;                  /**< the tokens themselves */
} SingleMappingRecord, 
    *SingleMapping;
...
typedef struct _mapping {
  ...
  int64_t nr_classes;               /**< the number of single mappings currently in this Mapping */
