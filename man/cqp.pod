...
specified by the C<CORPUS_REGISTRY> environment variable will be used; if that is not available, 
...
registry directory is scanned for available copora when CQP starts up. 
