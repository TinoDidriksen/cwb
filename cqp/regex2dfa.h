 ...
 */
typedef struct dfa {
  int32_t Max_States;     /**< max number of states of the current dfa;
                               state no. 0 is the initial state.             */
  int32_t Max_Input;      /**< max number of input chars of the current dfa. */
  int32_t **TransTable;   /**< state transition table of the current dfa.    */
  Boolean *Final;         /**< set of final states.                          */
  int32_t E_State;        /**< Error State -- it is introduced in order to
